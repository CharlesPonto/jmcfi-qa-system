      ...
      <div className="flex-1 lg:ml-64 flex flex-col min-h-screen w-full transition-all duration-300">
        ...
        <main className="p-4 md:p-8 space-y-6 md:space-y-8">
          ...
          <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-extrabold text-gray-800 tracking-tight">Level 3</h2>
              <p className="text-xs md:text-sm text-gray-500 font-medium">Advanced Program Evaluation & Sustainability</p>
            </div>
